...
<header class="shadow-xl">
    ...
    <div class="relative block lg:hidden w-full aspect-square overflow-hidden bg-black" data-youtube-embed data-src="{{ $embedUrl }}" data-title="Nandini Jungle video hero" data-frame-class="absolute inset-1/2 w-[180%] h-[180%] -translate-x-1/2 -translate-y-1/2 pointer-events-none">
