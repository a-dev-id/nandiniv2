...
<head>
    ...
    <title>Your Membership Tier Has Been Updated</title>
</head>
                    ...
                    <tr>
                        <td style="padding:0 34px 38px;">
                            ...
                            <p style="margin:0 0 18px;font-size:15px;line-height:1.75;color:#344054;">
                                As your membership year has ended without any new booking-earned points, your membership tier has been downgraded from <strong>{{ $previousTierLabel }}</strong> to <strong>{{ $newTierLabel }}</strong>.
                            </p>

                            <p style="margin:0 0 18px;font-size:15px;line-height:1.75;color:#344054;">
                                As a result, some of the exclusive benefits available under the <strong>{{ $previousTierLabel }}</strong> tier are no longer included, and your points balance has been adjusted to match your new tier.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="width:100%;border-collapse:collapse;margin:0 0 26px;">
                                ...
                                <tr>
                                    <td style="width:42%;padding:13px 0;border-bottom:1px solid #eee8df;color:#667085;font-size:12px;text-transform:uppercase;letter-spacing:1.4px;">Current Points</td>
                                    <td style="padding:13px 0;border-bottom:1px solid #eee8df;color:#344054;font-size:14px;text-align:right;">{{ number_format($newPoints, 0) }}</td>
                                </tr>
                                <tr>
                                    <td style="width:42%;padding:13px 0;border-bottom:1px solid #eee8df;color:#667085;font-size:12px;text-transform:uppercase;letter-spacing:1.4px;">New Expiry Date</td>
                                    <td style="padding:13px 0;border-bottom:1px solid #eee8df;color:#344054;font-size:14px;text-align:right;">{{ $expiresAt }}</td>
                                </tr>
                            </table>

                            <p style="margin:0 0 18px;font-size:15px;line-height:1.75;color:#344054;">
                                Only the points above the maximum limit for the <strong>{{ $newTierLabel }}</strong> tier have been deducted. Your remaining points can still be redeemed for eligible rewards and experiences.
                            </p>

                            <p style="margin:0 0 18px;font-size:15px;line-height:1.75;color:#344054;">
                                To earn more points and regain your <strong>{{ $previousTierLabel }}</strong> status, simply book and stay with us again. Every eligible stay brings you closer to unlocking additional member benefits.
                            </p>
