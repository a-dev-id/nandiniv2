...
@if (filled(data_get($voucher->metadata, 'personal_message')))<div style="margin:0 0 24px;padding:18px 20px;background:#f8f5ef;border-left:3px solid #b8945b;color:#344054;font-family:Georgia,'Times New Roman',serif;font-size:16px;font-style:italic;line-height:1.7;">&ldquo;{{ data_get($voucher->metadata, 'personal_message') }}&rdquo;</div>@endif
