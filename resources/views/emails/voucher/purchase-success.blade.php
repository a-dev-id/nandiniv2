...
<tr><td style="padding:0 34px 38px;"><p style="margin:0 0 18px;font-size:15px;line-height:1.75;color:#344054;">Dear {{ $voucher->recipient_name ?: $order->purchaser_first_name }},</p><p style="margin:0 0 20px;font-size:15px;line-height:1.75;color:#344054;">Thank you for your purchase. Your Nandini voucher is ready and attached to this email as a PDF.</p>
...
@endforeach
</table><p style="margin:0 0 18px;font-size:15px;line-height:1.75;color:#344054;">Please present the voucher code or attached PDF when redeeming your experience.</p>
