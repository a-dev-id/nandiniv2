            ...
            <div class="mx-auto w-full max-w-[720px] overflow-hidden bg-white px-5 py-8 shadow-xl sm:px-8 md:px-10 md:py-10 lg:px-12">
                ...
                <form method="POST" action="{{ route('membership.profile.update') }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="flex flex-col items-center gap-4 text-center">
                        ...
                        <div class="w-full">
                            <label for="profile_photo" class="mb-3 block text-sm sm:text-sm uppercase text-slate-500">
                                Profile Photo
                            </label>

                            <input id="profile_photo" type="file" name="profile_photo" accept="image/jpeg,image/png,image/webp" class="w-full border border-slate-300 bg-white px-4 py-3 text-[14px] leading-7 text-slate-700 outline-none transition file:mr-4 file:border-0 file:bg-[#A67C3D] file:px-4 file:py-2 file:text-[11px] file:font-bold file:uppercase file:text-white focus:border-[#A67C3D]">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div>
                            <label for="first_name" class="mb-3 block text-sm sm:text-sm uppercase text-slate-500">
                                First Name
                            </label>

                            <input id="first_name" type="text" name="first_name" value="{{ $firstName }}" class="w-full border border-slate-300 bg-white px-4 py-3 text-sm leading-7 text-slate-700 outline-none transition focus:border-[#A67C3D]">
                        </div>

                        <div>
                            <label for="last_name" class="mb-3 block text-sm sm:text-sm uppercase text-slate-500">
                                Last Name
                            </label>

                            <input id="last_name" type="text" name="last_name" value="{{ $lastName }}" class="w-full border border-slate-300 bg-white px-4 py-3 text-sm leading-7 text-slate-700 outline-none transition focus:border-[#A67C3D]">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input id="email" type="email" value="{{ $member->email }}" disabled class="w-full cursor-not-allowed border border-slate-200 bg-slate-100 px-4 py-3 text-sm leading-7 text-slate-500">
                    ...
                    <div>
                        <label for="country" class="mb-3 block text-sm sm:text-sm uppercase text-slate-500">
                            Country
                        </label>

                        <select id="country" name="country" data-country-select class="block w-full max-w-full min-w-0 border border-slate-300 bg-white px-4 py-3 text-sm leading-7 text-slate-700 outline-none transition focus:border-[#A67C3D]">
                    ...
                    <div class="grid min-w-0 gap-6 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
                        <div class="min-w-0">
                            <label for="phone" class="mb-3 block text-sm sm:text-sm uppercase text-slate-500">
                            ...
                            <div class="flex w-full max-w-full min-w-0 overflow-hidden border border-slate-300 bg-white transition focus-within:border-[#A67C3D]">
                                <select name="phone_code" data-phone-code-select aria-label="Country phone code" class="w-[94px] shrink-0 border-0 border-r border-slate-300 bg-white px-3 py-3 text-sm leading-7 text-slate-700 outline-none sm:w-[104px]">
                                ...
                                <input id="phone" type="tel" name="phone" value="{{ $phoneNumber }}" autocomplete="tel" placeholder="812 3456 7890" class="min-w-0 flex-1 border-0 bg-white px-3 py-3 text-sm leading-7 text-slate-700 outline-none sm:px-4">
                            </div>
                        </div>

                        <div class="min-w-0">
                            <label for="date_of_birth" class="mb-3 block text-sm sm:text-sm uppercase text-slate-500">
                                Date of Birth
                            </label>

                            <input id="date_of_birth" type="date" name="date_of_birth" value="{{ $dateOfBirth }}" class="block w-full max-w-full min-w-0 border border-slate-300 bg-white px-4 py-3 text-sm leading-7 text-slate-700 outline-none transition focus:border-[#A67C3D]">
                        </div>
                    </div>

                    <div>
                        <label for="address" class="mb-3 block text-sm sm:text-sm uppercase text-slate-500">
                            Address
                        </label>

                        <textarea id="address" name="address" rows="4" class="w-full border border-slate-300 bg-white px-4 py-3 text-sm leading-7 text-slate-700 outline-none transition focus:border-[#A67C3D]">{{ $address }}</textarea>
                    </div>

                    <div class="border-t border-slate-200 pt-6">
                        <h2 class="text-xl uppercase text-slate-700 mb-3">
                            Change Password
                        </h2>
                    ...
                    <div>
                        ...
                        <input id="current_password" type="password" name="current_password" autocomplete="current-password" class="w-full border border-slate-300 bg-white px-4 py-3 text-sm leading-7 text-slate-700 outline-none transition focus:border-[#A67C3D]">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <input id="password" type="password" name="password" autocomplete="new-password" class="w-full border border-slate-300 bg-white px-4 py-3 text-sm leading-7 text-slate-700 outline-none transition focus:border-[#A67C3D]">
                        ...
                        <div>
                            ...
                            <input id="password_confirmation" type="password" name="password_confirmation" autocomplete="new-password" class="w-full border border-slate-300 bg-white px-4 py-3 text-sm leading-7 text-slate-700 outline-none transition focus:border-[#A67C3D]">
                        </div>
                    </div>
