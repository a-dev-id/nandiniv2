...
<x-layouts.app>
    ...
    <section class="bg-white px-3 py-14 sm:px-6 md:py-20" aria-labelledby="upcoming-events-heading">
        <div class="mx-auto max-w-7xl">
            <div class="mb-8 text-center md:mb-10">
    ...
    <section class="bg-slate-50 px-3 py-14 sm:px-6 md:py-20" aria-labelledby="regular-events-heading">
        <div class="mx-auto max-w-7xl">
            <div class="mb-8 text-center md:mb-10">
