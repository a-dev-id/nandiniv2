...
class InquiryOptions
{
    ...
    public static function phoneCodes(): array
    {
        $codes = [
            ...
            ['Cape Verde', '+238'], ['Cayman Islands', '+1-345'], ['Central African Republic', '+236'], ['Chad', '+235'],
            ...
            ['Guadeloupe', '+590'], ['Guam', '+1-671'], ['Guatemala', '+502'], ['Guernsey', '+44-1481'],
            ...
            ['Ivory Coast', '+225'], ['Jamaica', '+1-876'], ['Japan', '+81'], ['Jersey', '+44-1534'],
            ...
            ['North Korea', '+850'], ['North Macedonia', '+389'], ['Northern Mariana Islands', '+1-670'], ['Norway', '+47'],
            ...
            ['Puerto Rico', '+1-939'], ['Qatar', '+974'], ['Reunion', '+262'], ['Romania', '+40'],
            ['Russia', '+7'], ['Rwanda', '+250'], ['Saint Barthelemy', '+590'], ['Saint Helena', '+290'],
            ['Saint Kitts and Nevis', '+1-869'], ['Saint Lucia', '+1-758'], ['Saint Martin', '+590'],
            ['Saint Pierre and Miquelon', '+508'], ['Saint Vincent and the Grenadines', '+1-784'],
            ...
            ['Turks and Caicos Islands', '+1-649'], ['Tuvalu', '+688'], ['U.S. Virgin Islands', '+1-340'],
            ['Uganda', '+256'], ['Ukraine', '+380'], ['United Arab Emirates', '+971'], ['United Kingdom', '+44'],
            ['United States', '+1'], ['Uruguay', '+598'], ['Uzbekistan', '+998'], ['Vanuatu', '+678'],
            ['Vatican City', '+379'], ['Venezuela', '+58'], ['Vietnam', '+84'], ['Wallis and Futuna', '+681'],
