                        ...
                        Section::make('Award Details')
                            ...
                            ->schema([
                                TextInput::make('award_name')
                                    ->label('Award Name')
                                    ->placeholder('Example: Best Jungle Resort')
                                    ->maxLength(191),

                                TextInput::make('awarded_by')
                                    ->label('Awarded By')
                                    ->placeholder('Example: Travel + Leisure')
                                    ->maxLength(191),

                                TextInput::make('award_year')
                                    ->label('Award Year')
                        ...
                        Section::make('Card Image')
                            ...
                            ->schema([
                                FileUpload::make('card_image')
                                    ->label('Award Card Image')
                                    ->disk('public')
                                    ->directory('awards/cards')
                                    ->visibility('public')
                                    ->image()
                                    ->acceptedFileTypes(['image/jpeg', 'image/png', 'image/webp'])
                                    ->imagePreviewHeight('160')
                                ...
                                TextInput::make('card_image_alt')
                                    ...
                                    ->placeholder('Describe the award card image')
                                    ->maxLength(191),
                            ]),
