...
namespace App\Filament\Resources\Honeymoons\Schemas;
        ...
        return $schema
            ...
            ->components([
                Grid::make()
                    ...
                    ->schema([
                        Section::make('Honeymoon Content')
                            ->columnSpanFull()
                            ->columns(2)
                            ->schema([
                                ...
                                DatePicker::make('valid_start_date')
                                    ...
                                    ->native(false)
                                    ->helperText('Honeymoon package will start showing from this date.'),

                                DatePicker::make('valid_end_date')
                                    ->label('Valid End Date')
                                    ->native(false)
                                    ->helperText('Honeymoon package will stop showing after this date.'),
                                ...
                                TextInput::make('button_url')
                                    ...
                                    ->placeholder('Example: honeymoon.index or https://...')
                                    ->maxLength(191),
                            ]),
                        ...
                        Section::make('Booking Engine')
                            ...
                            ->schema([
                                ...
                                Textarea::make('booking_url_override')
                                    ...
                                    ->placeholder('Paste full booking engine URL only if this honeymoon package needs a special URL.')
                                    ->rows(3)
                                    ->columnSpanFull()
                        ...
                        Section::make('Hero Images')
                            ...
                            ->schema([
                                ...
                                FileUpload::make('hero_mobile_image')
                                    ...
                                    ->disk('public')
                                    ->directory('honeymoons/hero-mobile')
                                    ->visibility('public')
                                    ->image()
                                    ->acceptedFileTypes(['image/jpeg', 'image/png', 'image/webp'])
                                    ->imagePreviewHeight('160')
                        ...
                        Section::make('Card Image')
                            ...
                            ->schema([
                                FileUpload::make('card_image')
                                    ->label('Honeymoon Card Image')
                                    ->disk('public')
                                    ->directory('honeymoons/cards')
                                    ->visibility('public')
                                    ->image()
                                    ->acceptedFileTypes(['image/jpeg', 'image/png', 'image/webp'])
                                    ->imagePreviewHeight('160')
                                ...
                                TextInput::make('card_image_alt')
                                    ...
                                    ->placeholder('Describe the honeymoon card image')
                                    ->maxLength(191),
                            ]),
