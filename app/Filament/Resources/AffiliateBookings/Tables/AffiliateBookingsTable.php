    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('commission_state')->label('Commission State')->badge()->formatStateUsing(fn (AffiliateCommissionState $state, AffiliateBooking $record): string => $record->commissionStatusLabel())->color(fn (AffiliateCommissionState $state): string => $state->badgeColor()),
